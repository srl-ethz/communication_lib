...
void PositionSubscriber::SubListener::on_subscription_matched(
        DataReader*,
...
void PositionSubscriber::SubListener::on_data_available(
        DataReader* reader)
{
    // Take data
    Position st;
