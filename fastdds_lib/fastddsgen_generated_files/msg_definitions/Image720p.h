...
#ifndef _IDL_MSG_IMAGE720P_H_
#define _IDL_MSG_IMAGE720P_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(Image720p_SOURCE)
#define Image720p_DllAPI __declspec( dllexport )
#else
#define Image720p_DllAPI __declspec( dllimport )
#endif // Image720p_SOURCE
#else
#define Image720p_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define Image720p_DllAPI
#endif // _WIN32
...
namespace idl_msg {
    ...
    public:
         ...
         */
        eProsima_user_DllExport const std::array<uint8_t, 1280*720*3>& frame() const;

        /*!
         * @brief This function returns a reference to member frame
         * @return Reference to member frame
         */
        eProsima_user_DllExport std::array<uint8_t, 1280*720*3>& frame();
    ...
    private:
        ...
        std::array<uint8_t, 1280*720*3> m_frame;
    };
} // namespace idl_msg

#endif // _IDL_MSG_IMAGE720P_H_