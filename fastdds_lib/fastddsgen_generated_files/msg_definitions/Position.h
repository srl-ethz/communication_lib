...
#ifndef _IDL_MSG_POSITION_H_
#define _IDL_MSG_POSITION_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(Position_SOURCE)
#define Position_DllAPI __declspec( dllexport )
#else
#define Position_DllAPI __declspec( dllimport )
#endif // Position_SOURCE
#else
#define Position_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define Position_DllAPI
#endif // _WIN32
...
namespace idl_msg {
    ...
    public:
         ...
         * @param x Reference to the object idl_msg::Position that will be copied.
         */
        eProsima_user_DllExport Position(
                const Position& x);
