...
#ifndef _IDL_MSG_QUATERNION_H_
#define _IDL_MSG_QUATERNION_H_
...
namespace idl_msg {
    ...
    public:
         ...
         * @param x Reference to the object idl_msg::Quaternion that will be copied.
         */
        eProsima_user_DllExport Quaternion(
                const Quaternion& x);
