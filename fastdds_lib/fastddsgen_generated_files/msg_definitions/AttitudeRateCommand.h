...
#ifndef _ATTITUDERATECOMMAND_H_
#define _ATTITUDERATECOMMAND_H_
...
public:
     ...
     * @param x Reference to the object AttitudeRateCommand that will be copied.
     */
    eProsima_user_DllExport AttitudeRateCommand(
