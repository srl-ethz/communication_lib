...
public:
     ...
     */
    eProsima_user_DllExport const std::array<uint8_t, 1000000>& frame() const;

    /*!
     * @brief This function returns a reference to member frame
     * @return Reference to member frame
     */
    eProsima_user_DllExport std::array<uint8_t, 1000000>& frame();
...
private:
    ...
    Header m_header;
    std::array<uint8_t, 1000000> m_frame;
};
