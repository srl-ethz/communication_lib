 ...
 */
void ImageHD::frame(
        const std::array<uint8_t, 3>& _frame)
{
    m_frame = _frame;
}
 ...
 */
const std::array<uint8_t, 3>& ImageHD::frame() const
{
    return m_frame;
}
 ...
 */
std::array<uint8_t, 3>& ImageHD::frame()
{
    return m_frame;
}
