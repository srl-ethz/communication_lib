...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ec756bd
    m_timestamp_ = 0;
    // m_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c72f59f
    m_valid_ = false;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@60dcc9fe
    m_type_ = 0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@222114ba
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@16e7dcfd
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3d121db3
    m_vz_ = 0.0;
    // m_velocity_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b07a0d6
    m_velocity_valid_ = false;
    // m_velocity_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11a9e7c8
    m_velocity_frame_ = 0;
    // m_alt_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3901d134
    m_alt_valid_ = false;
    // m_lat_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14d3bc22
    m_lat_ = 0.0;
    // m_lon_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12d4bf7e
    m_lon_ = 0.0;
    // m_alt_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c1d9d4b
    m_alt_ = 0.0;
    // m_yaw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7b227d8d
    m_yaw_ = 0.0;
    // m_yaw_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7219ec67
    m_yaw_valid_ = false;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@45018215
    m_yawspeed_ = 0.0;
    // m_yawspeed_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@65d6b83b
    m_yawspeed_valid_ = false;
    // m_landing_gear_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d706f19
    m_landing_gear_ = 0;
    // m_loiter_radius_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@30b7c004
    m_loiter_radius_ = 0.0;
    // m_loiter_direction_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@79efed2d
    m_loiter_direction_ = 0;
    // m_acceptance_radius_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2928854b
    m_acceptance_radius_ = 0.0;
    // m_cruising_speed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@27ae2fd0
    m_cruising_speed_ = 0.0;
    // m_cruising_throttle_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@29176cc1
    m_cruising_throttle_ = 0.0;
    // m_disable_weather_vane_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f177a4b
...
position_setpoint& position_setpoint::operator =(
        const position_setpoint& x)
{
...
size_t position_setpoint::getMaxCdrSerializedSize(
...
size_t position_setpoint::getCdrSerializedSize(
        const position_setpoint& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void position_setpoint::serialize(
...
void position_setpoint::deserialize(
 ...
 */
void position_setpoint::timestamp_(
 ...
 */
void position_setpoint::velocity_valid_(
        bool _velocity_valid_)
{
 ...
 */
void position_setpoint::velocity_frame_(
        uint8_t _velocity_frame_)
{
 ...
 */
void position_setpoint::alt_valid_(
        bool _alt_valid_)
{
 ...
 */
void position_setpoint::yaw_valid_(
        bool _yaw_valid_)
{
 ...
 */
void position_setpoint::yawspeed_(
        float _yawspeed_)
{
 ...
 */
void position_setpoint::yawspeed_valid_(
        bool _yawspeed_valid_)
{
 ...
 */
void position_setpoint::landing_gear_(
        uint8_t _landing_gear_)
{
 ...
 */
void position_setpoint::loiter_radius_(
        float _loiter_radius_)
{
 ...
 */
void position_setpoint::loiter_direction_(
        uint8_t _loiter_direction_)
{
 ...
 */
void position_setpoint::acceptance_radius_(
        float _acceptance_radius_)
{
 ...
 */
void position_setpoint::cruising_speed_(
        float _cruising_speed_)
{
 ...
 */
void position_setpoint::cruising_throttle_(
        float _cruising_throttle_)
{
 ...
 */
void position_setpoint::disable_weather_vane_(
        bool _disable_weather_vane_)
{
...
size_t position_setpoint::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void position_setpoint::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
