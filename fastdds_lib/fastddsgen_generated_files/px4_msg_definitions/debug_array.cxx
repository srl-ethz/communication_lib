...
debug_array::debug_array()
{
    ...
    m_timestamp_ = 0;
    // m_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12028586
    m_id_ = 0;
    // m_name com.eprosima.idl.parser.typecode.AliasTypeCode@17776a8
    memset(&m_name, 0, (10) * 1);
    // m_data com.eprosima.idl.parser.typecode.AliasTypeCode@69a10787
...
debug_array& debug_array::operator =(
        const debug_array& x)
{
...
size_t debug_array::getMaxCdrSerializedSize(
...
size_t debug_array::getCdrSerializedSize(
        const debug_array& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
 ...
 */
void debug_array::name(
        const debug_array__char_array_10& _name)
{
    m_name = _name;
}
 ...
 */
void debug_array::name(
        debug_array__char_array_10&& _name)
{
 ...
 */
void debug_array::data(
        const debug_array__float_array_58& _data)
{
    m_data = _data;
}
 ...
 */
void debug_array::data(
        debug_array__float_array_58&& _data)
{
...
size_t debug_array::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
