...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ebd319f
    m_timestamp_ = 0;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c0be339
    m_type_ = 0;
    // m_waypoints com.eprosima.idl.parser.typecode.AliasTypeCode@15ca7889
...
vehicle_trajectory_waypoint::vehicle_trajectory_waypoint(
        const vehicle_trajectory_waypoint& x)
{
...
vehicle_trajectory_waypoint& vehicle_trajectory_waypoint::operator =(
        const vehicle_trajectory_waypoint& x)
{
...
size_t vehicle_trajectory_waypoint::getMaxCdrSerializedSize(
...
size_t vehicle_trajectory_waypoint::getCdrSerializedSize(
        const vehicle_trajectory_waypoint& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void vehicle_trajectory_waypoint::serialize(
...
void vehicle_trajectory_waypoint::deserialize(
 ...
 */
void vehicle_trajectory_waypoint::timestamp_(
 ...
 */
void vehicle_trajectory_waypoint::type_(
        uint8_t _type_)
{
    m_type_ = _type_;
}
 ...
 */
void vehicle_trajectory_waypoint::waypoints(
        const vehicle_trajectory_waypoint__trajectory_waypoint_array_5& _waypoints)
{
 ...
 */
void vehicle_trajectory_waypoint::waypoints(
        vehicle_trajectory_waypoint__trajectory_waypoint_array_5&& _waypoints)
{
...
size_t vehicle_trajectory_waypoint::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void vehicle_trajectory_waypoint::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
