...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a192cfe
    m_timestamp_ = 0;
    // m_source_protocol_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5119fb47
    m_source_protocol_ = 0;
    // m_remote_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7193666c
    m_remote_timestamp_ = 0;
    // m_observed_offset_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20deea7f
    m_observed_offset_ = 0;
    // m_estimated_offset_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3835c46
    m_estimated_offset_ = 0;
    // m_round_trip_time_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dde4cb2
...
timesync_status& timesync_status::operator =(
        const timesync_status& x)
{
...
size_t timesync_status::getMaxCdrSerializedSize(
...
size_t timesync_status::getCdrSerializedSize(
        const timesync_status& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void timesync_status::serialize(
...
void timesync_status::deserialize(
 ...
 */
void timesync_status::timestamp_(
 ...
 */
void timesync_status::source_protocol_(
        uint8_t _source_protocol_)
{
 ...
 */
void timesync_status::remote_timestamp_(
        uint64_t _remote_timestamp_)
{
 ...
 */
void timesync_status::observed_offset_(
        int64_t _observed_offset_)
{
 ...
 */
void timesync_status::estimated_offset_(
        int64_t _estimated_offset_)
{
 ...
 */
void timesync_status::round_trip_time_(
        uint32_t _round_trip_time_)
{
...
size_t timesync_status::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void timesync_status::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
