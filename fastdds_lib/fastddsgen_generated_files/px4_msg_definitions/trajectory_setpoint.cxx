...
trajectory_setpoint::trajectory_setpoint()
{
    ...
    m_timestamp_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4a94ee4
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4cc451f2
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6379eb
    m_z_ = 0.0;
    // m_yaw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@294425a7
    m_yaw_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@67d48005
    m_yawspeed_ = 0.0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@9f116cc
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12468a38
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1aa7ecca
    m_vz_ = 0.0;
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@59309333
    memset(&m_acceleration, 0, (3) * 4);
    // m_jerk com.eprosima.idl.parser.typecode.AliasTypeCode@59309333
    memset(&m_jerk, 0, (3) * 4);
    // m_thrust com.eprosima.idl.parser.typecode.AliasTypeCode@59309333
...
trajectory_setpoint& trajectory_setpoint::operator =(
        const trajectory_setpoint& x)
{
...
size_t trajectory_setpoint::getMaxCdrSerializedSize(
...
size_t trajectory_setpoint::getCdrSerializedSize(
        const trajectory_setpoint& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void trajectory_setpoint::serialize(
...
void trajectory_setpoint::deserialize(
 ...
 */
void trajectory_setpoint::timestamp_(
 ...
 */
void trajectory_setpoint::yawspeed_(
        float _yawspeed_)
{
 ...
 */
void trajectory_setpoint::acceleration(
        const trajectory_setpoint__float_array_3& _acceleration)
{
 ...
 */
void trajectory_setpoint::acceleration(
        trajectory_setpoint__float_array_3&& _acceleration)
{
 ...
 */
void trajectory_setpoint::jerk(
        const trajectory_setpoint__float_array_3& _jerk)
{
    m_jerk = _jerk;
}
 ...
 */
void trajectory_setpoint::jerk(
        trajectory_setpoint__float_array_3&& _jerk)
{
 ...
 */
void trajectory_setpoint::thrust(
        const trajectory_setpoint__float_array_3& _thrust)
{
    m_thrust = _thrust;
}
 ...
 */
void trajectory_setpoint::thrust(
        trajectory_setpoint__float_array_3&& _thrust)
{
...
size_t trajectory_setpoint::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void trajectory_setpoint::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
