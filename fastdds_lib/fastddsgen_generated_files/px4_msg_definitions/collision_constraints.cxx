...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71623278
    m_timestamp_ = 0;
    // m_original_setpoint com.eprosima.idl.parser.typecode.AliasTypeCode@768b970c
    memset(&m_original_setpoint, 0, (2) * 4);
    // m_adapted_setpoint com.eprosima.idl.parser.typecode.AliasTypeCode@768b970c
...
collision_constraints& collision_constraints::operator =(
        const collision_constraints& x)
{
...
size_t collision_constraints::getMaxCdrSerializedSize(
...
size_t collision_constraints::getCdrSerializedSize(
        const collision_constraints& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void collision_constraints::serialize(
...
void collision_constraints::deserialize(
 ...
 */
void collision_constraints::timestamp_(
 ...
 */
void collision_constraints::original_setpoint(
        const collision_constraints__float_array_2& _original_setpoint)
{
 ...
 */
void collision_constraints::original_setpoint(
        collision_constraints__float_array_2&& _original_setpoint)
{
 ...
 */
void collision_constraints::adapted_setpoint(
        const collision_constraints__float_array_2& _adapted_setpoint)
{
 ...
 */
void collision_constraints::adapted_setpoint(
        collision_constraints__float_array_2&& _adapted_setpoint)
{
...
size_t collision_constraints::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void collision_constraints::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
