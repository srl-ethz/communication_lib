...
public:
     ...
     * @param x Reference to the object vehicle_status that will be copied.
     */
    eProsima_user_DllExport vehicle_status& operator =(
            const vehicle_status& x);
     ...
     */
    eProsima_user_DllExport void nav_state_(
            uint8_t _nav_state_);
     ...
     */
    eProsima_user_DllExport void nav_state_timestamp_(
     ...
     */
    eProsima_user_DllExport void arming_state_(
     ...
     */
    eProsima_user_DllExport void hil_state_(
            uint8_t _hil_state_);
     ...
     */
    eProsima_user_DllExport void failsafe_(
            bool _failsafe_);
     ...
     */
    eProsima_user_DllExport void failsafe_timestamp_(
     ...
     */
    eProsima_user_DllExport void system_type_(
     ...
     */
    eProsima_user_DllExport void system_id_(
            uint8_t _system_id_);
     ...
     */
    eProsima_user_DllExport void component_id_(
     ...
     */
    eProsima_user_DllExport void vehicle_type_(
     ...
     */
    eProsima_user_DllExport void is_vtol_(
            bool _is_vtol_);
     ...
     */
    eProsima_user_DllExport void is_vtol_tailsitter_(
     ...
     */
    eProsima_user_DllExport void vtol_fw_permanent_stab_(
     ...
     */
    eProsima_user_DllExport void in_transition_mode_(
     ...
     */
    eProsima_user_DllExport void in_transition_to_fw_(
     ...
     */
    eProsima_user_DllExport void rc_signal_lost_(
     ...
     */
    eProsima_user_DllExport void rc_input_mode_(
     ...
     */
    eProsima_user_DllExport void data_link_lost_(
     ...
     */
    eProsima_user_DllExport void data_link_lost_counter_(
     ...
     */
    eProsima_user_DllExport void high_latency_data_link_lost_(
     ...
     */
    eProsima_user_DllExport void engine_failure_(
     ...
     */
    eProsima_user_DllExport void mission_failure_(
     ...
     */
    eProsima_user_DllExport void geofence_violated_(
     ...
     */
    eProsima_user_DllExport void failure_detector_status_(
     ...
     */
    eProsima_user_DllExport void onboard_control_sensors_present_(
     ...
     */
    eProsima_user_DllExport void onboard_control_sensors_enabled_(
     ...
     */
    eProsima_user_DllExport void onboard_control_sensors_health_(
     ...
     */
    eProsima_user_DllExport void latest_arming_reason_(
     ...
     */
    eProsima_user_DllExport void latest_disarming_reason_(
     ...
     */
    eProsima_user_DllExport void armed_time_(
     ...
     */
    eProsima_user_DllExport void takeoff_time_(
