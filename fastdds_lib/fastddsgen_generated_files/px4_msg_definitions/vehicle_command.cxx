...
vehicle_command::vehicle_command()
{
    ...
    m_timestamp_ = 0;
    // m_param1_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6aeb35e6
    m_param1_ = 0.0;
    // m_param2_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1283bb96
    m_param2_ = 0.0;
    // m_param3_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@74f0ea28
    m_param3_ = 0.0;
    // m_param4_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f6efaab
    m_param4_ = 0.0;
    // m_param5_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c19aaa5
    m_param5_ = 0.0;
    // m_param6_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3349e9bb
    m_param6_ = 0.0;
    // m_param7_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@409bf450
    m_param7_ = 0.0;
    // m_command_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@38d8f54a
    m_command_ = 0;
    // m_target_system_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49e53c76
    m_target_system_ = 0;
    // m_target_component_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@351d00c0
    m_target_component_ = 0;
    // m_source_system_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a3b5b47
    m_source_system_ = 0;
    // m_source_component_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55b699ef
    m_source_component_ = 0;
    // m_confirmation_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@35d019a3
    m_confirmation_ = 0;
    // m_from_external_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@689604d9
...
vehicle_command& vehicle_command::operator =(
        const vehicle_command& x)
{
...
size_t vehicle_command::getMaxCdrSerializedSize(
...
size_t vehicle_command::getCdrSerializedSize(
        const vehicle_command& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void vehicle_command::serialize(
...
void vehicle_command::deserialize(
 ...
 */
void vehicle_command::timestamp_(
 ...
 */
void vehicle_command::target_system_(
        uint8_t _target_system_)
{
 ...
 */
void vehicle_command::target_component_(
        uint8_t _target_component_)
{
 ...
 */
void vehicle_command::source_system_(
        uint8_t _source_system_)
{
 ...
 */
void vehicle_command::source_component_(
        uint8_t _source_component_)
{
 ...
 */
void vehicle_command::confirmation_(
        uint8_t _confirmation_)
{
 ...
 */
void vehicle_command::from_external_(
        bool _from_external_)
{
...
size_t vehicle_command::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void vehicle_command::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
