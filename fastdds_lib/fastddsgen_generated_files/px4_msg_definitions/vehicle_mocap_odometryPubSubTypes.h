...
#error Generated vehicle_mocap_odometry is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // GEN_API_VER
 ...
 */
class vehicle_mocap_odometryPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:
    ...
    {
        new (memory) vehicle_mocap_odometry();
        return true;
    }
