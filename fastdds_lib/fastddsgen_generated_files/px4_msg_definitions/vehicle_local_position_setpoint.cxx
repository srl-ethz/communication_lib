...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@75d4a5c2
    m_timestamp_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@557caf28
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@408d971b
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6c6cb480
    m_z_ = 0.0;
    // m_yaw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c46e67a
    m_yaw_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c730b35
    m_yawspeed_ = 0.0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@206a70ef
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@292b08d6
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@22555ebf
    m_vz_ = 0.0;
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@36ebc363
    memset(&m_acceleration, 0, (3) * 4);
    // m_jerk com.eprosima.idl.parser.typecode.AliasTypeCode@36ebc363
    memset(&m_jerk, 0, (3) * 4);
    // m_thrust com.eprosima.idl.parser.typecode.AliasTypeCode@36ebc363
...
vehicle_local_position_setpoint::vehicle_local_position_setpoint(
        const vehicle_local_position_setpoint& x)
{
...
vehicle_local_position_setpoint& vehicle_local_position_setpoint::operator =(
        const vehicle_local_position_setpoint& x)
{
...
size_t vehicle_local_position_setpoint::getMaxCdrSerializedSize(
...
size_t vehicle_local_position_setpoint::getCdrSerializedSize(
        const vehicle_local_position_setpoint& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void vehicle_local_position_setpoint::serialize(
...
void vehicle_local_position_setpoint::deserialize(
 ...
 */
void vehicle_local_position_setpoint::timestamp_(
 ...
 */
void vehicle_local_position_setpoint::x_(
        float _x_)
{
    m_x_ = _x_;
}
 ...
 */
void vehicle_local_position_setpoint::y_(
        float _y_)
{
    m_y_ = _y_;
}
 ...
 */
void vehicle_local_position_setpoint::z_(
        float _z_)
{
    m_z_ = _z_;
}
 ...
 */
void vehicle_local_position_setpoint::yaw_(
        float _yaw_)
{
    m_yaw_ = _yaw_;
}
 ...
 */
void vehicle_local_position_setpoint::yawspeed_(
        float _yawspeed_)
{
 ...
 */
void vehicle_local_position_setpoint::vx_(
        float _vx_)
{
    m_vx_ = _vx_;
}
 ...
 */
void vehicle_local_position_setpoint::vy_(
        float _vy_)
{
    m_vy_ = _vy_;
}
 ...
 */
void vehicle_local_position_setpoint::vz_(
        float _vz_)
{
    m_vz_ = _vz_;
}
 ...
 */
void vehicle_local_position_setpoint::acceleration(
        const vehicle_local_position_setpoint__float_array_3& _acceleration)
{
 ...
 */
void vehicle_local_position_setpoint::acceleration(
        vehicle_local_position_setpoint__float_array_3&& _acceleration)
{
 ...
 */
void vehicle_local_position_setpoint::jerk(
        const vehicle_local_position_setpoint__float_array_3& _jerk)
{
    m_jerk = _jerk;
}
 ...
 */
void vehicle_local_position_setpoint::jerk(
        vehicle_local_position_setpoint__float_array_3&& _jerk)
{
 ...
 */
void vehicle_local_position_setpoint::thrust(
        const vehicle_local_position_setpoint__float_array_3& _thrust)
{
    m_thrust = _thrust;
}
 ...
 */
void vehicle_local_position_setpoint::thrust(
        vehicle_local_position_setpoint__float_array_3&& _thrust)
{
...
size_t vehicle_local_position_setpoint::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void vehicle_local_position_setpoint::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
