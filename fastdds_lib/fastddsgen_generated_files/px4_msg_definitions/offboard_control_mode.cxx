...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@589b3632
    m_timestamp_ = 0;
    // m_position_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@45f45fa1
    m_position_ = false;
    // m_velocity_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c6e276e
    m_velocity_ = false;
    // m_acceleration_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@534df152
    m_acceleration_ = false;
    // m_attitude_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@8e0379d
    m_attitude_ = false;
    // m_body_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@341b80b2
    m_body_rate_ = false;
...
offboard_control_mode& offboard_control_mode::operator =(
        const offboard_control_mode& x)
{
...
size_t offboard_control_mode::getMaxCdrSerializedSize(
...
size_t offboard_control_mode::getCdrSerializedSize(
        const offboard_control_mode& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void offboard_control_mode::serialize(
...
void offboard_control_mode::deserialize(
 ...
 */
void offboard_control_mode::timestamp_(
 ...
 */
void offboard_control_mode::position_(
        bool _position_)
{
 ...
 */
void offboard_control_mode::velocity_(
        bool _velocity_)
{
 ...
 */
void offboard_control_mode::acceleration_(
        bool _acceleration_)
{
 ...
 */
void offboard_control_mode::attitude_(
        bool _attitude_)
{
 ...
 */
void offboard_control_mode::body_rate_(
        bool _body_rate_)
{
...
size_t offboard_control_mode::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void offboard_control_mode::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
