...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5656be13
    m_timestamp_ = 0;
    // m_flag_armed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4218d6a3
    m_flag_armed_ = false;
    // m_flag_multicopter_position_control_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76505305
    m_flag_multicopter_position_control_enabled_ = false;
    // m_flag_control_manual_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14cd1699
    m_flag_control_manual_enabled_ = false;
    // m_flag_control_auto_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77888435
    m_flag_control_auto_enabled_ = false;
    // m_flag_control_offboard_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@73a1e9a9
    m_flag_control_offboard_enabled_ = false;
    // m_flag_control_rates_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71d44a3
    m_flag_control_rates_enabled_ = false;
    // m_flag_control_attitude_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7b98f307
    m_flag_control_attitude_enabled_ = false;
    // m_flag_control_acceleration_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4802796d
    m_flag_control_acceleration_enabled_ = false;
    // m_flag_control_velocity_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@34123d65
    m_flag_control_velocity_enabled_ = false;
    // m_flag_control_position_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59474f18
    m_flag_control_position_enabled_ = false;
    // m_flag_control_altitude_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@65fb9ffc
    m_flag_control_altitude_enabled_ = false;
    // m_flag_control_climb_rate_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e694b3f
    m_flag_control_climb_rate_enabled_ = false;
    // m_flag_control_termination_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1bb5a082
...
vehicle_control_mode& vehicle_control_mode::operator =(
        const vehicle_control_mode& x)
{
...
size_t vehicle_control_mode::getMaxCdrSerializedSize(
...
size_t vehicle_control_mode::getCdrSerializedSize(
        const vehicle_control_mode& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void vehicle_control_mode::serialize(
...
void vehicle_control_mode::deserialize(
 ...
 */
void vehicle_control_mode::timestamp_(
 ...
 */
void vehicle_control_mode::flag_armed_(
        bool _flag_armed_)
{
 ...
 */
void vehicle_control_mode::flag_multicopter_position_control_enabled_(
        bool _flag_multicopter_position_control_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_manual_enabled_(
        bool _flag_control_manual_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_auto_enabled_(
        bool _flag_control_auto_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_offboard_enabled_(
        bool _flag_control_offboard_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_rates_enabled_(
        bool _flag_control_rates_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_attitude_enabled_(
        bool _flag_control_attitude_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_acceleration_enabled_(
        bool _flag_control_acceleration_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_velocity_enabled_(
        bool _flag_control_velocity_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_position_enabled_(
        bool _flag_control_position_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_altitude_enabled_(
        bool _flag_control_altitude_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_climb_rate_enabled_(
        bool _flag_control_climb_rate_enabled_)
{
 ...
 */
void vehicle_control_mode::flag_control_termination_enabled_(
        bool _flag_control_termination_enabled_)
{
...
size_t vehicle_control_mode::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void vehicle_control_mode::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
