...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@52e6fdee
    m_timestamp_ = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@6c80d78a
    memset(&m_position, 0, (3) * 4);
    // m_yaw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@62150f9e
    m_yaw_ = 0.0;
    // m_delta_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a451d4d
    m_delta_ = 0.0;
...
trajectory_bezier& trajectory_bezier::operator =(
        const trajectory_bezier& x)
{
...
size_t trajectory_bezier::getMaxCdrSerializedSize(
...
size_t trajectory_bezier::getCdrSerializedSize(
        const trajectory_bezier& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void trajectory_bezier::serialize(
...
void trajectory_bezier::deserialize(
 ...
 */
void trajectory_bezier::timestamp_(
 ...
 */
void trajectory_bezier::position(
        const trajectory_bezier__float_array_3& _position)
{
 ...
 */
void trajectory_bezier::position(
        trajectory_bezier__float_array_3&& _position)
{
...
size_t trajectory_bezier::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void trajectory_bezier::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
