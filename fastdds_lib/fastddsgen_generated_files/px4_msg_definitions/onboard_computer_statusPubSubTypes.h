...
#error Generated onboard_computer_status is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // GEN_API_VER
 ...
 */
class onboard_computer_statusPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:
    ...
    {
        new (memory) onboard_computer_status();
        return true;
    }
