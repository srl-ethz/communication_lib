...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@56de5251
    m_timestamp_ = 0;
    // m_previous_ com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@419c5f1a

    // m_current_ com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@419c5f1a

    // m_next_ com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@419c5f1a
...
position_setpoint_triplet::position_setpoint_triplet(
        const position_setpoint_triplet& x)
{
...
position_setpoint_triplet& position_setpoint_triplet::operator =(
        const position_setpoint_triplet& x)
{
...
size_t position_setpoint_triplet::getMaxCdrSerializedSize(
...
size_t position_setpoint_triplet::getCdrSerializedSize(
        const position_setpoint_triplet& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void position_setpoint_triplet::serialize(
...
void position_setpoint_triplet::deserialize(
 ...
 */
void position_setpoint_triplet::timestamp_(
 ...
 */
void position_setpoint_triplet::previous_(
        const position_setpoint& _previous_)
{
 ...
 */
void position_setpoint_triplet::current_(
        const position_setpoint& _current_)
{
 ...
 */
void position_setpoint_triplet::next_(
        const position_setpoint& _next_)
{
    m_next_ = _next_;
}
...
size_t position_setpoint_triplet::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void position_setpoint_triplet::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
