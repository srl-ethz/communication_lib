...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@b7f23d9
    m_timestamp_ = 0;
    // m_ind_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61d47554
    m_ind_ = 0;
    // m_value_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69b794e2
    m_value_ = 0.0;
...
debug_value& debug_value::operator =(
        const debug_value& x)
{
...
size_t debug_value::getMaxCdrSerializedSize(
...
size_t debug_value::getCdrSerializedSize(
        const debug_value& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
size_t debug_value::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
