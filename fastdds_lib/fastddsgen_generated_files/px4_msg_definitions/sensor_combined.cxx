...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@363ee3a2
    m_timestamp_ = 0;
    // m_gyro_rad com.eprosima.idl.parser.typecode.AliasTypeCode@4690b489
    memset(&m_gyro_rad, 0, (3) * 4);
    // m_gyro_integral_dt_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@79b06cab
    m_gyro_integral_dt_ = 0;
    // m_accelerometer_timestamp_relative_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3eb7fc54
    m_accelerometer_timestamp_relative_ = 0;
    // m_accelerometer_m_s2 com.eprosima.idl.parser.typecode.AliasTypeCode@4690b489
    memset(&m_accelerometer_m_s2, 0, (3) * 4);
    // m_accelerometer_integral_dt_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7f552bd3
    m_accelerometer_integral_dt_ = 0;
    // m_accelerometer_clipping_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c22fc4c
...
sensor_combined& sensor_combined::operator =(
        const sensor_combined& x)
{
...
size_t sensor_combined::getMaxCdrSerializedSize(
...
size_t sensor_combined::getCdrSerializedSize(
        const sensor_combined& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void sensor_combined::serialize(
...
void sensor_combined::deserialize(
 ...
 */
void sensor_combined::timestamp_(
 ...
 */
void sensor_combined::gyro_rad(
        const sensor_combined__float_array_3& _gyro_rad)
{
 ...
 */
void sensor_combined::gyro_rad(
        sensor_combined__float_array_3&& _gyro_rad)
{
 ...
 */
void sensor_combined::gyro_integral_dt_(
        uint32_t _gyro_integral_dt_)
{
 ...
 */
void sensor_combined::accelerometer_timestamp_relative_(
        int32_t _accelerometer_timestamp_relative_)
{
 ...
 */
void sensor_combined::accelerometer_m_s2(
        const sensor_combined__float_array_3& _accelerometer_m_s2)
{
 ...
 */
void sensor_combined::accelerometer_m_s2(
        sensor_combined__float_array_3&& _accelerometer_m_s2)
{
 ...
 */
void sensor_combined::accelerometer_integral_dt_(
        uint32_t _accelerometer_integral_dt_)
{
 ...
 */
void sensor_combined::accelerometer_clipping_(
        uint8_t _accelerometer_clipping_)
{
...
size_t sensor_combined::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void sensor_combined::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
