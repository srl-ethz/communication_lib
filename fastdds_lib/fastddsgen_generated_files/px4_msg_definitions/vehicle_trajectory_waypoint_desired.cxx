...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3f56875e
    m_timestamp_ = 0;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2b4bac49
    m_type_ = 0;
    // m_waypoints com.eprosima.idl.parser.typecode.AliasTypeCode@fd07cbb
...
vehicle_trajectory_waypoint_desired::vehicle_trajectory_waypoint_desired(
        const vehicle_trajectory_waypoint_desired& x)
{
...
vehicle_trajectory_waypoint_desired::vehicle_trajectory_waypoint_desired(
        vehicle_trajectory_waypoint_desired&& x)
{
    m_timestamp_ = x.m_timestamp_;
    m_type_ = x.m_type_;
...
vehicle_trajectory_waypoint_desired& vehicle_trajectory_waypoint_desired::operator =(
        const vehicle_trajectory_waypoint_desired& x)
{
...
size_t vehicle_trajectory_waypoint_desired::getMaxCdrSerializedSize(
...
size_t vehicle_trajectory_waypoint_desired::getCdrSerializedSize(
        const vehicle_trajectory_waypoint_desired& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void vehicle_trajectory_waypoint_desired::serialize(
...
void vehicle_trajectory_waypoint_desired::deserialize(
 ...
 */
void vehicle_trajectory_waypoint_desired::timestamp_(
 ...
 */
void vehicle_trajectory_waypoint_desired::type_(
        uint8_t _type_)
{
    m_type_ = _type_;
}
 ...
 */
void vehicle_trajectory_waypoint_desired::waypoints(
        const vehicle_trajectory_waypoint_desired__trajectory_waypoint_array_5& _waypoints)
{
 ...
 */
void vehicle_trajectory_waypoint_desired::waypoints(
        vehicle_trajectory_waypoint_desired__trajectory_waypoint_array_5&& _waypoints)
{
...
size_t vehicle_trajectory_waypoint_desired::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void vehicle_trajectory_waypoint_desired::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
