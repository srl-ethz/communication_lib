...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3cc1435c
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6bf0219d
    m_timestamp_sample_ = 0;
    // m_local_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@dd0c991
    m_local_frame_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5f16132a
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69fb6037
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@36d585c
    m_z_ = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@87a85e1
    memset(&m_q, 0, (4) * 4);
    // m_q_offset com.eprosima.idl.parser.typecode.AliasTypeCode@87a85e1
    memset(&m_q_offset, 0, (4) * 4);
    // m_pose_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@671a5887
    memset(&m_pose_covariance, 0, (21) * 4);
    // m_velocity_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5552768b
    m_velocity_frame_ = 0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c947bc5
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@609db43b
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55f616cf
    m_vz_ = 0.0;
    // m_rollspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1356d4d4
    m_rollspeed_ = 0.0;
    // m_pitchspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c03cf28
    m_pitchspeed_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1329eff
    m_yawspeed_ = 0.0;
    // m_velocity_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@671a5887
...
vehicle_visual_odometry::vehicle_visual_odometry(
        const vehicle_visual_odometry& x)
{
...
vehicle_visual_odometry& vehicle_visual_odometry::operator =(
        const vehicle_visual_odometry& x)
{
...
size_t vehicle_visual_odometry::getMaxCdrSerializedSize(
...
size_t vehicle_visual_odometry::getCdrSerializedSize(
        const vehicle_visual_odometry& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void vehicle_visual_odometry::serialize(
...
void vehicle_visual_odometry::deserialize(
 ...
 */
void vehicle_visual_odometry::timestamp_(
 ...
 */
void vehicle_visual_odometry::timestamp_sample_(
        uint64_t _timestamp_sample_)
{
 ...
 */
void vehicle_visual_odometry::local_frame_(
        uint8_t _local_frame_)
{
 ...
 */
void vehicle_visual_odometry::x_(
        float _x_)
{
    m_x_ = _x_;
}
 ...
 */
void vehicle_visual_odometry::y_(
        float _y_)
{
    m_y_ = _y_;
}
 ...
 */
void vehicle_visual_odometry::z_(
        float _z_)
{
    m_z_ = _z_;
}
 ...
 */
void vehicle_visual_odometry::q(
        const vehicle_visual_odometry__float_array_4& _q)
{
    m_q = _q;
}
 ...
 */
void vehicle_visual_odometry::q(
        vehicle_visual_odometry__float_array_4&& _q)
{
    m_q = std::move(_q);
}
 ...
 */
void vehicle_visual_odometry::q_offset(
        const vehicle_visual_odometry__float_array_4& _q_offset)
{
 ...
 */
void vehicle_visual_odometry::q_offset(
        vehicle_visual_odometry__float_array_4&& _q_offset)
{
 ...
 */
void vehicle_visual_odometry::pose_covariance(
        const vehicle_visual_odometry__float_array_21& _pose_covariance)
{
 ...
 */
void vehicle_visual_odometry::pose_covariance(
        vehicle_visual_odometry__float_array_21&& _pose_covariance)
{
 ...
 */
void vehicle_visual_odometry::velocity_frame_(
 ...
 */
void vehicle_visual_odometry::vx_(
        float _vx_)
{
    m_vx_ = _vx_;
}
 ...
 */
void vehicle_visual_odometry::vy_(
        float _vy_)
{
    m_vy_ = _vy_;
}
 ...
 */
void vehicle_visual_odometry::vz_(
        float _vz_)
{
    m_vz_ = _vz_;
}
 ...
 */
void vehicle_visual_odometry::rollspeed_(
        float _rollspeed_)
{
 ...
 */
void vehicle_visual_odometry::pitchspeed_(
        float _pitchspeed_)
{
 ...
 */
void vehicle_visual_odometry::yawspeed_(
        float _yawspeed_)
{
 ...
 */
void vehicle_visual_odometry::velocity_covariance(
        const vehicle_visual_odometry__float_array_21& _velocity_covariance)
{
 ...
 */
void vehicle_visual_odometry::velocity_covariance(
        vehicle_visual_odometry__float_array_21&& _velocity_covariance)
{
...
size_t vehicle_visual_odometry::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void vehicle_visual_odometry::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
