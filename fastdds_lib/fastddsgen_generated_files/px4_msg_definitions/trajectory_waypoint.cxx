...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@74fe5c40
    m_timestamp_ = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@3febb011
    memset(&m_position, 0, (3) * 4);
    // m_velocity com.eprosima.idl.parser.typecode.AliasTypeCode@3febb011
    memset(&m_velocity, 0, (3) * 4);
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@3febb011
    memset(&m_acceleration, 0, (3) * 4);
    // m_yaw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10e31a9a
    m_yaw_ = 0.0;
    // m_yaw_speed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@131774fe
    m_yaw_speed_ = 0.0;
    // m_point_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@158d2680
    m_point_valid_ = false;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77847718
    m_type_ = 0;
...
trajectory_waypoint& trajectory_waypoint::operator =(
        const trajectory_waypoint& x)
{
...
size_t trajectory_waypoint::getMaxCdrSerializedSize(
...
size_t trajectory_waypoint::getCdrSerializedSize(
        const trajectory_waypoint& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void trajectory_waypoint::serialize(
...
void trajectory_waypoint::deserialize(
 ...
 */
void trajectory_waypoint::timestamp_(
 ...
 */
void trajectory_waypoint::position(
        const trajectory_waypoint__float_array_3& _position)
{
 ...
 */
void trajectory_waypoint::position(
        trajectory_waypoint__float_array_3&& _position)
{
 ...
 */
void trajectory_waypoint::velocity(
        const trajectory_waypoint__float_array_3& _velocity)
{
 ...
 */
void trajectory_waypoint::velocity(
        trajectory_waypoint__float_array_3&& _velocity)
{
 ...
 */
void trajectory_waypoint::acceleration(
        const trajectory_waypoint__float_array_3& _acceleration)
{
 ...
 */
void trajectory_waypoint::acceleration(
        trajectory_waypoint__float_array_3&& _acceleration)
{
 ...
 */
void trajectory_waypoint::yaw_speed_(
        float _yaw_speed_)
{
 ...
 */
void trajectory_waypoint::point_valid_(
        bool _point_valid_)
{
 ...
 */
void trajectory_waypoint::type_(
        uint8_t _type_)
{
    m_type_ = _type_;
}
...
size_t trajectory_waypoint::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void trajectory_waypoint::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
