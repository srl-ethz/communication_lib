...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6989da5e
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@385c9627
    m_timestamp_sample_ = 0;
    // m_local_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@139982de
    m_local_frame_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@682b2fa
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@217ed35e
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7dcf94f8
    m_z_ = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@229f66ed
    memset(&m_q, 0, (4) * 4);
    // m_q_offset com.eprosima.idl.parser.typecode.AliasTypeCode@229f66ed
    memset(&m_q_offset, 0, (4) * 4);
    // m_pose_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@31190526
    memset(&m_pose_covariance, 0, (21) * 4);
    // m_velocity_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@662ac478
    m_velocity_frame_ = 0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6743e411
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3eb25e1a
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@477b4cdf
    m_vz_ = 0.0;
    // m_rollspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77c2494c
    m_rollspeed_ = 0.0;
    // m_pitchspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f5958c9
    m_pitchspeed_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@233795b6
    m_yawspeed_ = 0.0;
    // m_velocity_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@31190526
...
vehicle_mocap_odometry::vehicle_mocap_odometry(
        const vehicle_mocap_odometry& x)
{
...
vehicle_mocap_odometry& vehicle_mocap_odometry::operator =(
        const vehicle_mocap_odometry& x)
{
...
size_t vehicle_mocap_odometry::getMaxCdrSerializedSize(
...
size_t vehicle_mocap_odometry::getCdrSerializedSize(
        const vehicle_mocap_odometry& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void vehicle_mocap_odometry::serialize(
...
void vehicle_mocap_odometry::deserialize(
 ...
 */
void vehicle_mocap_odometry::timestamp_(
 ...
 */
void vehicle_mocap_odometry::timestamp_sample_(
 ...
 */
void vehicle_mocap_odometry::local_frame_(
 ...
 */
void vehicle_mocap_odometry::x_(
        float _x_)
{
    m_x_ = _x_;
}
 ...
 */
void vehicle_mocap_odometry::y_(
        float _y_)
{
    m_y_ = _y_;
}
 ...
 */
void vehicle_mocap_odometry::z_(
        float _z_)
{
    m_z_ = _z_;
}
 ...
 */
void vehicle_mocap_odometry::q(
        const vehicle_mocap_odometry__float_array_4& _q)
{
    m_q = _q;
}
 ...
 */
void vehicle_mocap_odometry::q(
        vehicle_mocap_odometry__float_array_4&& _q)
{
    m_q = std::move(_q);
}
 ...
 */
void vehicle_mocap_odometry::q_offset(
        const vehicle_mocap_odometry__float_array_4& _q_offset)
{
 ...
 */
void vehicle_mocap_odometry::q_offset(
        vehicle_mocap_odometry__float_array_4&& _q_offset)
{
 ...
 */
void vehicle_mocap_odometry::pose_covariance(
        const vehicle_mocap_odometry__float_array_21& _pose_covariance)
{
 ...
 */
void vehicle_mocap_odometry::pose_covariance(
        vehicle_mocap_odometry__float_array_21&& _pose_covariance)
{
 ...
 */
void vehicle_mocap_odometry::velocity_frame_(
 ...
 */
void vehicle_mocap_odometry::vx_(
        float _vx_)
{
    m_vx_ = _vx_;
}
 ...
 */
void vehicle_mocap_odometry::vy_(
        float _vy_)
{
    m_vy_ = _vy_;
}
 ...
 */
void vehicle_mocap_odometry::vz_(
        float _vz_)
{
    m_vz_ = _vz_;
}
 ...
 */
void vehicle_mocap_odometry::rollspeed_(
        float _rollspeed_)
{
 ...
 */
void vehicle_mocap_odometry::pitchspeed_(
        float _pitchspeed_)
{
 ...
 */
void vehicle_mocap_odometry::yawspeed_(
        float _yawspeed_)
{
 ...
 */
void vehicle_mocap_odometry::velocity_covariance(
        const vehicle_mocap_odometry__float_array_21& _velocity_covariance)
{
 ...
 */
void vehicle_mocap_odometry::velocity_covariance(
        vehicle_mocap_odometry__float_array_21&& _velocity_covariance)
{
...
size_t vehicle_mocap_odometry::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void vehicle_mocap_odometry::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
