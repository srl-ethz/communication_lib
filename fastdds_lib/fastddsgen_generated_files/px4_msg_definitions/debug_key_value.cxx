...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6166e06f
    m_timestamp_ = 0;
    // m_key com.eprosima.idl.parser.typecode.AliasTypeCode@49e202ad
    memset(&m_key, 0, (10) * 1);
    // m_value_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1c72da34
    m_value_ = 0.0;
...
debug_key_value& debug_key_value::operator =(
        const debug_key_value& x)
{
...
size_t debug_key_value::getMaxCdrSerializedSize(
...
size_t debug_key_value::getCdrSerializedSize(
        const debug_key_value& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void debug_key_value::serialize(
...
void debug_key_value::deserialize(
 ...
 */
void debug_key_value::timestamp_(
 ...
 */
void debug_key_value::key(
        const debug_key_value__char_array_10& _key)
{
    m_key = _key;
}
 ...
 */
void debug_key_value::key(
        debug_key_value__char_array_10&& _key)
{
    m_key = std::move(_key);
}
...
size_t debug_key_value::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void debug_key_value::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
