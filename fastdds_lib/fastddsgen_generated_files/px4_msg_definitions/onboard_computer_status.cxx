...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@53ca01a2
    m_timestamp_ = 0;
    // m_uptime_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@358c99f5
    m_uptime_ = 0;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3ee0fea4
    m_type_ = 0;
    // m_cpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@48524010
    memset(&m_cpu_cores, 0, (8) * 1);
    // m_cpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@4b168fa9
    memset(&m_cpu_combined, 0, (10) * 1);
    // m_gpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@1a84f40f
    memset(&m_gpu_cores, 0, (4) * 1);
    // m_gpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@4b168fa9
    memset(&m_gpu_combined, 0, (10) * 1);
    // m_temperature_board_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23282c25
    m_temperature_board_ = 0;
    // m_temperature_core com.eprosima.idl.parser.typecode.AliasTypeCode@48524010
    memset(&m_temperature_core, 0, (8) * 1);
    // m_fan_speed com.eprosima.idl.parser.typecode.AliasTypeCode@7920ba90
    memset(&m_fan_speed, 0, (4) * 2);
    // m_ram_usage_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b419da
    m_ram_usage_ = 0;
    // m_ram_total_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b2da18f
    m_ram_total_ = 0;
    // m_storage_type com.eprosima.idl.parser.typecode.AliasTypeCode@5906ebcb
    memset(&m_storage_type, 0, (4) * 4);
    // m_storage_usage com.eprosima.idl.parser.typecode.AliasTypeCode@5906ebcb
    memset(&m_storage_usage, 0, (4) * 4);
    // m_storage_total com.eprosima.idl.parser.typecode.AliasTypeCode@5906ebcb
    memset(&m_storage_total, 0, (4) * 4);
    // m_link_type com.eprosima.idl.parser.typecode.AliasTypeCode@258e2e41
    memset(&m_link_type, 0, (6) * 4);
    // m_link_tx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@258e2e41
    memset(&m_link_tx_rate, 0, (6) * 4);
    // m_link_rx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@258e2e41
    memset(&m_link_rx_rate, 0, (6) * 4);
    // m_link_tx_max com.eprosima.idl.parser.typecode.AliasTypeCode@258e2e41
    memset(&m_link_tx_max, 0, (6) * 4);
    // m_link_rx_max com.eprosima.idl.parser.typecode.AliasTypeCode@258e2e41
...
onboard_computer_status::onboard_computer_status(
        const onboard_computer_status& x)
{
...
onboard_computer_status& onboard_computer_status::operator =(
        const onboard_computer_status& x)
{
...
size_t onboard_computer_status::getMaxCdrSerializedSize(
...
size_t onboard_computer_status::getCdrSerializedSize(
        const onboard_computer_status& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void onboard_computer_status::serialize(
...
void onboard_computer_status::deserialize(
 ...
 */
void onboard_computer_status::timestamp_(
 ...
 */
void onboard_computer_status::uptime_(
        uint32_t _uptime_)
{
    m_uptime_ = _uptime_;
}
 ...
 */
void onboard_computer_status::type_(
        uint8_t _type_)
{
    m_type_ = _type_;
}
 ...
 */
void onboard_computer_status::cpu_cores(
        const onboard_computer_status__octet_array_8& _cpu_cores)
{
 ...
 */
void onboard_computer_status::cpu_cores(
        onboard_computer_status__octet_array_8&& _cpu_cores)
{
 ...
 */
void onboard_computer_status::cpu_combined(
        const onboard_computer_status__octet_array_10& _cpu_combined)
{
 ...
 */
void onboard_computer_status::cpu_combined(
        onboard_computer_status__octet_array_10&& _cpu_combined)
{
 ...
 */
void onboard_computer_status::gpu_cores(
        const onboard_computer_status__octet_array_4& _gpu_cores)
{
 ...
 */
void onboard_computer_status::gpu_cores(
        onboard_computer_status__octet_array_4&& _gpu_cores)
{
 ...
 */
void onboard_computer_status::gpu_combined(
        const onboard_computer_status__octet_array_10& _gpu_combined)
{
 ...
 */
void onboard_computer_status::gpu_combined(
        onboard_computer_status__octet_array_10&& _gpu_combined)
{
 ...
 */
void onboard_computer_status::temperature_board_(
        uint8_t _temperature_board_)
{
 ...
 */
void onboard_computer_status::temperature_core(
        const onboard_computer_status__octet_array_8& _temperature_core)
{
 ...
 */
void onboard_computer_status::temperature_core(
        onboard_computer_status__octet_array_8&& _temperature_core)
{
 ...
 */
void onboard_computer_status::fan_speed(
        const onboard_computer_status__short_array_4& _fan_speed)
{
 ...
 */
void onboard_computer_status::fan_speed(
        onboard_computer_status__short_array_4&& _fan_speed)
{
 ...
 */
void onboard_computer_status::ram_usage_(
        uint32_t _ram_usage_)
{
 ...
 */
void onboard_computer_status::ram_total_(
        uint32_t _ram_total_)
{
 ...
 */
void onboard_computer_status::storage_type(
        const onboard_computer_status__unsigned_long_array_4& _storage_type)
{
 ...
 */
void onboard_computer_status::storage_type(
        onboard_computer_status__unsigned_long_array_4&& _storage_type)
{
 ...
 */
void onboard_computer_status::storage_usage(
        const onboard_computer_status__unsigned_long_array_4& _storage_usage)
{
 ...
 */
void onboard_computer_status::storage_usage(
        onboard_computer_status__unsigned_long_array_4&& _storage_usage)
{
 ...
 */
void onboard_computer_status::storage_total(
        const onboard_computer_status__unsigned_long_array_4& _storage_total)
{
 ...
 */
void onboard_computer_status::storage_total(
        onboard_computer_status__unsigned_long_array_4&& _storage_total)
{
 ...
 */
void onboard_computer_status::link_type(
        const onboard_computer_status__unsigned_long_array_6& _link_type)
{
 ...
 */
void onboard_computer_status::link_type(
        onboard_computer_status__unsigned_long_array_6&& _link_type)
{
 ...
 */
void onboard_computer_status::link_tx_rate(
        const onboard_computer_status__unsigned_long_array_6& _link_tx_rate)
{
 ...
 */
void onboard_computer_status::link_tx_rate(
        onboard_computer_status__unsigned_long_array_6&& _link_tx_rate)
{
 ...
 */
void onboard_computer_status::link_rx_rate(
        const onboard_computer_status__unsigned_long_array_6& _link_rx_rate)
{
 ...
 */
void onboard_computer_status::link_rx_rate(
        onboard_computer_status__unsigned_long_array_6&& _link_rx_rate)
{
 ...
 */
void onboard_computer_status::link_tx_max(
        const onboard_computer_status__unsigned_long_array_6& _link_tx_max)
{
 ...
 */
void onboard_computer_status::link_tx_max(
        onboard_computer_status__unsigned_long_array_6&& _link_tx_max)
{
 ...
 */
void onboard_computer_status::link_rx_max(
        const onboard_computer_status__unsigned_long_array_6& _link_rx_max)
{
 ...
 */
void onboard_computer_status::link_rx_max(
        onboard_computer_status__unsigned_long_array_6&& _link_rx_max)
{
...
size_t onboard_computer_status::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void onboard_computer_status::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
