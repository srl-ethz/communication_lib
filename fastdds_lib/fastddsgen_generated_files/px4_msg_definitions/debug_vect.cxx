...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c540f5a
    m_timestamp_ = 0;
    // m_name com.eprosima.idl.parser.typecode.AliasTypeCode@770c2e6b
    memset(&m_name, 0, (10) * 1);
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a052a00
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77e9807f
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@448ff1a8
    m_z_ = 0.0;
...
debug_vect& debug_vect::operator =(
        const debug_vect& x)
{
...
size_t debug_vect::getMaxCdrSerializedSize(
...
size_t debug_vect::getCdrSerializedSize(
        const debug_vect& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
 ...
 */
void debug_vect::name(
        const debug_vect__char_array_10& _name)
{
    m_name = _name;
}
 ...
 */
void debug_vect::name(
        debug_vect__char_array_10&& _name)
{
...
size_t debug_vect::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
