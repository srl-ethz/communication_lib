...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2cd76f31
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@367ffa75
    m_timestamp_sample_ = 0;
    // m_local_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49438269
    m_local_frame_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ba2f4ec
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1c1bbc4e
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55fe41ea
    m_z_ = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@fbd1f6
    memset(&m_q, 0, (4) * 4);
    // m_q_offset com.eprosima.idl.parser.typecode.AliasTypeCode@fbd1f6
    memset(&m_q_offset, 0, (4) * 4);
    // m_pose_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@1ce24091
    memset(&m_pose_covariance, 0, (21) * 4);
    // m_velocity_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5dda768f
    m_velocity_frame_ = 0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7a8c8dcf
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24269709
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2aceadd4
    m_vz_ = 0.0;
    // m_rollspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24aed80c
    m_rollspeed_ = 0.0;
    // m_pitchspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3a52dba3
    m_pitchspeed_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a5c8d3f
    m_yawspeed_ = 0.0;
    // m_velocity_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@1ce24091
...
vehicle_odometry& vehicle_odometry::operator =(
        const vehicle_odometry& x)
{
...
size_t vehicle_odometry::getMaxCdrSerializedSize(
...
size_t vehicle_odometry::getCdrSerializedSize(
        const vehicle_odometry& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void vehicle_odometry::serialize(
...
void vehicle_odometry::deserialize(
 ...
 */
void vehicle_odometry::timestamp_(
 ...
 */
void vehicle_odometry::timestamp_sample_(
 ...
 */
void vehicle_odometry::local_frame_(
 ...
 */
void vehicle_odometry::q(
        const vehicle_odometry__float_array_4& _q)
{
    m_q = _q;
}
 ...
 */
void vehicle_odometry::q(
        vehicle_odometry__float_array_4&& _q)
{
    m_q = std::move(_q);
}
 ...
 */
void vehicle_odometry::q_offset(
        const vehicle_odometry__float_array_4& _q_offset)
{
 ...
 */
void vehicle_odometry::q_offset(
        vehicle_odometry__float_array_4&& _q_offset)
{
 ...
 */
void vehicle_odometry::pose_covariance(
        const vehicle_odometry__float_array_21& _pose_covariance)
{
 ...
 */
void vehicle_odometry::pose_covariance(
        vehicle_odometry__float_array_21&& _pose_covariance)
{
 ...
 */
void vehicle_odometry::velocity_frame_(
 ...
 */
void vehicle_odometry::rollspeed_(
        float _rollspeed_)
{
 ...
 */
void vehicle_odometry::pitchspeed_(
        float _pitchspeed_)
{
 ...
 */
void vehicle_odometry::yawspeed_(
        float _yawspeed_)
{
 ...
 */
void vehicle_odometry::velocity_covariance(
        const vehicle_odometry__float_array_21& _velocity_covariance)
{
 ...
 */
void vehicle_odometry::velocity_covariance(
        vehicle_odometry__float_array_21&& _velocity_covariance)
{
...
size_t vehicle_odometry::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
void vehicle_odometry::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
